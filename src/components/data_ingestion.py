...
# if you are only defining the variables just use the data class
# if you have some other funtions inside the class i will suggest go with __init__ constrcutor part
class DataIngestion:
    def __init__(self):
